...
{
    public static class ConfigureTablesExtension
    {
        public static void ConfigureTablesNaming(this ModelBuilder builder)
        {
        ...
        public static void SeedRolesAndAdmin(this ModelBuilder builder)
        {
